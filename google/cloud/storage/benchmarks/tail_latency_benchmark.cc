...
int main(int argc, char* argv[]) {
  ...
  auto options = google::cloud::Options{}
    ...
    .set<google::cloud::storage_experimental::ReadHedgeDelayOption>(std::chrono::milliseconds(500))
    .set<google::cloud::storage_experimental::MaxConcurrentHedgesOption>(15)
    .set<google::cloud::storage_experimental::HttpConnectTimeoutOption>(std::chrono::milliseconds(1000))
    .set<gcs::BackoffPolicyOption>(gcs::ExponentialBackoffPolicy(std::chrono::milliseconds(1), std::chrono::milliseconds(2), 2.0).clone())
